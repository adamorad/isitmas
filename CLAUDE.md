...
> Is the Israeli VAT threshold for overseas purchases  or ?

**Stack:** static (RTL/Hebrew)

## Project conventions
- All work happens on feature branches (`feat/*`, `fix/*`, `chore/*`); `main` is protected by the global block-main-branch hook.
- Old work goes to `archive/` instead of being deleted.
- Project-specific docs live in `docs/`.
- Notable changes recorded in `CHANGES.md`.
